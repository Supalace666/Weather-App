...
const WEATHER = (function () {
    ...
    // private keys for the api (Weather & Location)
    const darkSkyKey = '24498ab8f3acef81e02af28bc456cfe8',
        geocoderKey = '0d0526c8dd7f45608b1f131dcaf60694';
    ...
    const getWeather = (location, save) => {
        ...
        axios.get(geocodeURL)
            .then((res) => {
                ...
                // get latitude and longitude from OpenCageData
                let lat = res.data.results[0].geometry.lat,
                    lng = res.data.results[0].geometry.lng;

                // get a formated url for darkSky
